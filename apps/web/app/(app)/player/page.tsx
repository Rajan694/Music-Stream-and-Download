  ...
  return (
    <div className="max-w-3xl mx-auto h-[calc(100vh-100px)] flex flex-col justify-center pb-20">
      ...
      <div className="px-4 md:px-12 w-full max-w-xl mx-auto">
        ...
        {/* Scrubber (Visual only for now, real seeking needs DOM ref on input) */}
        ...
        <div className="flex items-center justify-between mt-8">
          ...
          >
            {/* The dedicated icon replaces a "1" badge that was positioned
                 absolutely against no positioned ancestor. */}
            {repeatMode === "one" ? (
        ...
        {/* Queue Panel inline for simplicity instead of actual Popover to save headlessui setup issues */}
        {isQueueOpen && (
