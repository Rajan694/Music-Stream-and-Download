...
export default function PlaylistPage({
  ...
  /**
   * Playlist entries are summaries without stream URLs, so the chosen track is
   * fetched in full before playback. The rest of the list is not pre-fetched —
   * that would be one provider call per entry.
   */
