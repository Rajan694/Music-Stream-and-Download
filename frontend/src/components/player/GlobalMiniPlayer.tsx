...
export function GlobalMiniPlayer() {
  ...
  return (
    <div className="fixed bottom-16 lg:bottom-4 left-0 lg:left-1/2 lg:-translate-x-1/2 right-0 lg:right-auto z-50 lg:w-[600px] w-full px-2 lg:px-0">
      <div className="bg-background-1/80 backdrop-blur-xl border border-white/10 lg:rounded-2xl rounded-xl shadow-2xl shadow-black/50 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-3 h-14 w-full gap-4">
          <Link
            to="/player"
            className="flex items-center gap-3 w-1/3 min-w-0 hover:bg-white/5 p-1.5 -ml-1.5 rounded-lg cursor-pointer group"
          >
            <div className="relative h-9 w-9 shrink-0 bg-background-2 rounded overflow-hidden">
            ...
            <div className="min-w-0 flex-1">
              <h4 className="text-[13px] font-semibold truncate text-zinc-100">
                {currentTrack.title}
              </h4>
          ...
          <div className="flex items-center justify-end gap-3 w-1/3 text-[11px] text-zinc-500 font-medium tabular-nums">
            {isAuthenticated && (
              <button
                ...
                className="p-1.5 rounded-lg hover:bg-white/10 text-zinc-400 hover:text-accent-primary transition-colors"
